# 🤖 ChatGPT Bulk Delete Manager (v1.2.0)

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Platform](https://img.shields.io/badge/Platform-Chrome%20%7C%20Edge%20%7C%20Brave-blue)](https://developer.chrome.com/docs/extensions/)
[![Manifest Version](https://img.shields.io/badge/Manifest-V3-emerald)](https://developer.chrome.com/docs/extensions/mv3/intro/)
[![Privacy](https://img.shields.io/badge/Privacy-100%25%20Local-purple)](#-privacy--security)
...
* **3-Panel Dashboard Layout:**
  * **Left Panel:** Statistics (Total Chats, Selected Chats, Est. Deletion Time), delay controls, and quick filters.
  * **Center Panel:** Scrollable list of chats rendered in a clean, single-column card grid to prevent title overlap.
  * **Right Panel:** A **live dialogue preview window** showing scrollable user (purple neon) and ChatGPT (dark glass) dialogue bubbles.
* **Mass Backup Export:** Download selected conversations in a single, structured Markdown (`.md`) file to keep a local archive of your chats before deletion.
...
* **Safe Deletion Queue:** Sequentially deletes conversations with custom safety delays (`0.5s` to `3.0s`) to avoid triggering ChatGPT's API rate limits or spam blockouts.
* **Bulletproof Visibility Fallbacks:** Launch the dashboard via:
  ...
  * Pressing **`Alt + B`** (or **`Option + B`** on Mac) at any time.
...
7. Open the manager by clicking the **"Bulk Clean"** capsule widget or pressing **`Alt + B`**!
...
* **Styling:** Custom CSS incorporating backdrop blurs, HSL-tailored colors, smooth animations, and glowing highlights.
* **APIs:** Integrates directly with ChatGPT's internal endpoints:
  ...
  * `PATCH /backend-api/conversation/{id}` (marks chats as invisible to delete them)
